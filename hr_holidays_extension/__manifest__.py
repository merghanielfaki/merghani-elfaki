...
==============================================
    ...
    * The department manager can request a holiday for him/her self only.
    """,
    'author':'Michael Telahun Makonnen <mmakonnen@gmail.com>, Openinside updated',
    ...
    'data': [
        ...
        'view/action.xml',
        'report/reports.xml',
        'view/hr_holidays_public.xml',
        'view/hr_holidays_status.xml',
        'view/hr_holidays.xml',
        'view/hr_holidays_calculator.xml',
        'view/refuseleave_reason.xml',
        'view/hr_accrual.xml',
        'view/action2.xml',
        'view/menu.xml',
        ...
        'data/hr_holidays_status.yml',
        'data/hr_holidays_approval.xml',
    ],
    'installable': True,
    'active': True,
}
